...
class Linspace(Benchmark):
    ...
    def time_linspace_scalar_th(self):
        c(np.linspace)(0, 10, 2)

    def time_linspace_array(self):
        np.linspace(self.d, 10, 10)

    def time_linspace_array_th(self):
        c(np.linspace)(self.d, 10, 10)
...
class Histogram1D(Benchmark):
    ...
    def time_full_coverage_th(self):
        c(np.histogram)(self.d, 200, (0, 100))

    def time_small_coverage(self):
        np.histogram(self.d, 200, (50, 51))

    def time_small_coverage_th(self):
        c(np.histogram)(self.d, 200, (50, 51))

    def time_fine_binning(self):
        np.histogram(self.d, 10000, (0, 100))

    def time_fine_binning_th(self):
        c(np.histogram)(self.d, 10000, (0, 100))
...
class Histogram2D(Benchmark):
    ...
    def time_full_coverage_th(self):
        c(np.histogramdd)(self.d, (200, 200), ((0, 100), (0, 100)))

    def time_small_coverage(self):
        np.histogramdd(self.d, (200, 200), ((50, 51), (50, 51)))

    def time_small_coverage_th(self):
        c(np.histogramdd)(self.d, (200, 200), ((50, 51), (50, 51)))

    def time_fine_binning(self):
        np.histogramdd(self.d, (10000, 10000), ((0, 100), (0, 100)))

    def time_fine_binning_th(self):
        c(np.histogramdd)(self.d, (10000, 10000), ((0, 100), (0, 100)))
...
class Bincount(Benchmark):
    ...
    def time_bincount_th(self):
        c(np.bincount)(self.d)

    def time_weights(self):
        np.bincount(self.d, weights=self.e)

    def time_weights_th(self):
        c(np.bincount)(self.d, weights=self.e)
...
class Mean(Benchmark):
    ...
    def time_mean_th(self, size):
        c(np.mean)(self.array)

    def time_mean_axis(self, size):
        np.mean(self.array, axis=1)

    def time_mean_axis_th(self, size):
        c(np.mean)(self.array, axis=1)
...
class Median(Benchmark):
    ...
    def time_even_th(self):
        c(np.median)(self.e)

    def time_odd(self):
        np.median(self.o)

    def time_odd_th(self):
        c(np.median)(self.o)

    def time_even_inplace(self):
        np.median(self.e, overwrite_input=True)

    def time_even_inplace_th(self):
        c(np.median)(self.e, overwrite_input=True)

    def time_odd_inplace(self):
        np.median(self.o, overwrite_input=True)

    def time_odd_inplace_th(self):
        c(np.median)(self.o, overwrite_input=True)

    def time_even_small(self):
        np.median(self.e[:500], overwrite_input=True)

    def time_even_small_th(self):
        c(np.median)(self.e[:500], overwrite_input=True)

    def time_odd_small(self):
        np.median(self.o[:500], overwrite_input=True)

    def time_odd_small_th(self):
        c(np.median)(self.o[:500], overwrite_input=True)

    def time_tall(self):
        np.median(self.tall, axis=-1)

    def time_tall_th(self):
        c(np.median)(self.tall, axis=-1)

    def time_wide(self):
        np.median(self.wide, axis=0)

    def time_wide_th(self):
        c(np.median)(self.wide, axis=0)
...
class Percentile(Benchmark):
    ...
    def time_quartile_th(self):
        c(np.percentile)(self.e, [25, 75])

    def time_percentile(self):
        np.percentile(self.e, [25, 35, 55, 65, 75])

    def time_percentile_th(self):
        c(np.percentile)(self.e, [25, 35, 55, 65, 75])

    def time_percentile_small(self):
        np.percentile(self.o, [25, 75])

    def time_percentile_small_th(self):
        c(np.percentile)(self.o, [25, 75])
...
class Select(Benchmark):
    ...
    def time_select_th(self):
        c(np.select)(self.cond, [self.d, self.e])

    def time_select_larger(self):
        np.select(self.cond_large, ([self.d, self.e] * 10))

    def time_select_larger_th(self):
        c(np.select)(self.cond_large, ([self.d, self.e] * 10))
...
class Sort(Benchmark):
    ...
    def time_sort_th(self, kind, dtype, array_type):
        c(np.sort)(self.arr, kind=kind)

    def time_argsort(self, kind, dtype, array_type):
        np.argsort(self.arr, kind=kind)

    def time_argsort_th(self, kind, dtype, array_type):
        c(np.argsort)(self.arr, kind=kind)
...
class Partition(Benchmark):
    ...
    def time_partition_th(self, dtype, array_type, k):
        temp = c(np.partition)(self.arr, k)

    def time_argpartition(self, dtype, array_type, k):
        temp = np.argpartition(self.arr, k)

    def time_argpartition_th(self, dtype, array_type, k):
        temp = c(np.argpartition)(self.arr, k)
...
class SortWorst(Benchmark):
    ...
    def time_sort_worst_th(self):
        c(np.sort)(self.worst)
...
class Where(Benchmark):
    ...
    def time_1_th(self):
        c(np.where)(self.cond)

    def time_2(self):
        np.where(self.cond, self.d, self.e)

    def time_2_th(self):
        c(np.where)(self.cond, self.d, self.e)

    def time_2_object(self):
        np.where(self.cond, self.d_o, self.e_o)

    def time_2_object_th(self):
        c(np.where)(self.cond, self.d_o, self.e_o)

    def time_2_broadcast(self):
        np.where(self.cond, self.d, 0)

    def time_2_broadcast_th(self):
        c(np.where)(self.cond, self.d, 0)

    def time_all_zeros(self):
        np.where(self.all_zeros)

    def time_all_zeros_th(self):
        c(np.where)(self.all_zeros)

    def time_random_01_percent(self):
        np.where(self.rand_cond_01)

    def time_random_01_percent_th(self):
        c(np.where)(self.rand_cond_01)

    def time_random_20_percent(self):
        np.where(self.rand_cond_20)

    def time_random_20_percent_th(self):
        c(np.where)(self.rand_cond_20)

    def time_random_30_percent(self):
        np.where(self.rand_cond_30)

    def time_random_30_percent_th(self):
        c(np.where)(self.rand_cond_30)

    def time_random_40_percent(self):
        np.where(self.rand_cond_40)

    def time_random_40_percent_th(self):
        c(np.where)(self.rand_cond_40)

    def time_random_50_percent(self):
        np.where(self.rand_cond_50)

    def time_random_50_percent_th(self):
        c(np.where)(self.rand_cond_50)

    def time_all_ones(self):
        np.where(self.all_ones)

    def time_all_ones_th(self):
        c(np.where)(self.all_ones)

    def time_interleaved_zeros_x2(self):
        np.where(self.rep_zeros_2)

    def time_interleaved_zeros_x2_th(self):
        c(np.where)(self.rep_zeros_2)

    def time_interleaved_zeros_x4(self):
        np.where(self.rep_zeros_4)

    def time_interleaved_zeros_x4_th(self):
        c(np.where)(self.rep_zeros_4)

    def time_interleaved_zeros_x8(self):
        np.where(self.rep_zeros_8)

    def time_interleaved_zeros_x8_th(self):
        c(np.where)(self.rep_zeros_8)

    def time_interleaved_ones_x2(self):
        np.where(self.rep_ones_2)

    def time_interleaved_ones_x2_th(self):
        c(np.where)(self.rep_ones_2)

    def time_interleaved_ones_x4(self):
        np.where(self.rep_ones_4)

    def time_interleaved_ones_x4_th(self):
        c(np.where)(self.rep_ones_4)

    def time_interleaved_ones_x8(self):
        np.where(self.rep_ones_8)

    def time_interleaved_ones_x8_th(self):
        c(np.where)(self.rep_ones_8)
